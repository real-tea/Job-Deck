...
import { applicant_auth, application_delete, applications_get_by_id, applications_get } from '../Controllers/applicant';
        ...
        if (localStorage.getItem("applicant_token")) {
            ...
            applicant_auth(obj).then(data => {
                if (data.tag) {
                    ...
                    applications_get_by_id(obj).then(data => {
                    ...
                    applications_get(obj).then(data => {
                        if (data.tag) {
                                        ...
                                        <div className="job-container flex flex-row m-10 shadow-2xl">
                                            ...
                                            <button
                                                onClick={() => {
                                                    ...
                                                    application_delete(obj).then(data => {
                                                        alert(data.message);
